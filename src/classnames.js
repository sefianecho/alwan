...
export const BUTTON_CLASSNAME = `${ALWAN_CLASSNAME}__${BUTTON}`;
export const COPY_BUTTON_CLASSNAME = `${ALWAN_CLASSNAME}__copy-${BUTTON}`;
export const SLIDER_CLASSNAME = `${ALWAN_CLASSNAME}__slider`;
export const SLIDERS_CLASSNAME = `${SLIDER_CLASSNAME}s`;
export const HUE_SLIDER_CLASSNAME = `${SLIDER_CLASSNAME}--hue`;
export const ALPHA_SLIDER_CLASSNAME = `${SLIDER_CLASSNAME}--alpha`;
export const INPUT_CLASSNAME = `${ALWAN_CLASSNAME}__${INPUT}`;
export const INPUTS_CLASSNAME = `${INPUT_CLASSNAME}s`;
export const SWATCH_CLASSNAME = `${ALWAN_CLASSNAME}__swatch`;
export const SWATCHES_CLASSNAME = `${SWATCH_CLASSNAME}es`;
...
export const COLLAPSE_BUTTON_CLASSNAME = `${ALWAN_CLASSNAME}__${COLLAPSE}-${BUTTON}`;

export const POPUP_CLASSNAME = `${ALWAN_CLASSNAME}--popup`;
export const OPEN_CLASSNAME = `${ALWAN_CLASSNAME}--${OPEN}`;
export const DISABLED_CLASSNAME = `${ALWAN_CLASSNAME}--disabled`;
export const FOCUS_CLASSNAME = `${ALWAN_CLASSNAME}--focus`;
