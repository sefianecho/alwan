...
import { MARKER_CLASSNAME, PALETTE_CLASSNAME } from '../constants/classnames';
import { ARIA_LABEL, ARROW_KEYS, KEY_DOWN, PALETTE_ID } from '../constants/globals';
